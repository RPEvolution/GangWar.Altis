...
*/
private["_dialog","_item","_itemInfo","_oldItem","_newItem","_upp","_itemName","_ui","_progress","_pgText","_cP","_allMaterial","_matsNeed","_invSize","_handledItem","_itemFilter","_backpackOldItems","_weight","_layer"];
...
if(!_removeItemSuccess) exitWith {_layer cutText ["","PLAIN"]; life_is_processing = false;};
